 ...
 */
package com.android.server.mist.display;
...
import com.android.server.mist.display.TwilightTracker.TwilightState;

import java.io.PrintWriter;
import java.util.BitSet;

import com.android.internal.mist.hardware.LineageHardwareManager;
import com.android.internal.mist.hardware.LiveDisplayManager;
import com.android.internal.util.mist.ColorUtils;

import static com.android.internal.mist.hardware.LiveDisplayManager.MODE_AUTO;
import static com.android.internal.mist.hardware.LiveDisplayManager.MODE_DAY;
import static com.android.internal.mist.hardware.LiveDisplayManager.MODE_NIGHT;
...
public class ColorTemperatureController extends LiveDisplayFeature {
    ...
    public ColorTemperatureController(Context context,
        ...
        mColorBalanceCurve = com.android.internal.util.mist.MathUtils.powerCurve(
    ...
    private int mapColorTemperatureToBalance(int temperature) {
        double z = com.android.internal.util.mist.MathUtils.powerCurveToLinear(mColorBalanceCurve, temperature);
